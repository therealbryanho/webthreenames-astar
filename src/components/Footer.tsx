import { contractScanURL, CONTRACT_ADDRESS } from '../utils/constants';

export default function Footer() {

  return (
    <div className="footer-container">
      <a className="footer-text" href={contractScanURL} target="_blank">Contract {CONTRACT_ADDRESS.substring(0, 4)}....{CONTRACT_ADDRESS.substring(CONTRACT_ADDRESS.length - 4, CONTRACT_ADDRESS.length)}</a>
      <br />
